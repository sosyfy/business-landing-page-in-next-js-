    ...
    <div className="container mx-auto w-full py-12 px-6">
      <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px] relative">
        <div className="lg:col-span-8 md:col-span-12">
          <div className="grid grid-cols-1 pb-8 mx-auto">
            <h3 className="mb-4 text-2xl font-semibold text-center  whitespace-nowrap md:text-3xl md:leading-normal">
              Instant Smart Solutions
            </h3>
          </div>
        </div>
        ...
        {arr.map((_, i) => (
          <div key={i} className="lg:col-span-4 md:col-span-6 col-span-12">
            <div className="px-6 py-10 transition duration-500 bg-white shadow hover:shadow-md rounded-2xl">
              <i
                data-feather="users"
                className="w-12 h-12 text-green-600 stroke-1"
              ></i>
              ...
              <div className="content mt-7">
                ...
                <p className="mt-3 text-slate-400">
                  ...
                  Officia magnam cum cumque officiis laboriosam sit, accusamus
                  molestias temporibus? Sapiente tempora sunt quam.
                  Necessitatibus libero alias ullam totam soluta veritatis.
                  Explicabo?
                </p>
                ...
                <div className="mt-5 cursor-pointer">
                  <a
                    href="#"
                    className="text-green-600 duration-500 ease-in-out cursor-pointer hover:text-green-600 after:bg-green-600"
                  >
